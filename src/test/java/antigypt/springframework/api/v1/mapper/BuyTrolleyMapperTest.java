...
class BuyTrolleyMapperTest {
    ...
    @Test
    void buyTrolleyDTOToBuyTrolley() {
        BuyTrolley buyTrolley1 = buyTrolleyMapper.buyTrolleyDTOToBuyTrolley(buyTrolleyDTO);
        assertNotNull(buyTrolley1);
    }

    @Test
    void buyTrolleyToBuyTrolleyDTO() {
        BuyTrolleyDTO buyTrolleyDTO1 = buyTrolleyMapper.buyTrolleyToBuyTrolleyDTO(buyTrolley);
        assertNotNull(buyTrolleyDTO1);
    }
}